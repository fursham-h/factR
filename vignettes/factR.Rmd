...
custom_matched.gtf <- matchGeneInfo(custom.gtf, ref.gtf)  
```  
...
```{r plottranscripts2}  
viewTranscripts(custom_matched.gtf, gene_name == "Zfr")  
```  
...
custom_new.gtf <- subsetNewTranscripts(custom_matched.gtf, ref.gtf)  
...
custom_new.gtf <- subsetNewTranscripts(custom_matched.gtf, ref.gtf, refine.by = "intron")  
viewTranscripts(custom_new.gtf, gene_name == "Zfr")  
```  
