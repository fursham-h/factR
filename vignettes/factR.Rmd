...
## Export exons and cds as GTF

After constructing query cds entries, one may be interested in combining the exon and cds objects and save it as a GTF file. factR comes a `exportExonsCDStoGTF` function which effeciently unlists the GRangeList objects, fill any missing important attributes (type and transcript_id) and export it as a GTF file
```{r export, eval = F}
# combine exons and cds objects
exportExonsCDStoGTF(newquery_exons, newquery_cds, 'path/to/output.gtf')
