...
#' 
#' # To quantify exon conservation scores using 60-way PhastCons Score (mm10)
#' NMD.exons_3 <- identifyNMDexons(out.gtf, Mmusculuse, NMD.result = NMD.output, ConsScores = "phastCons60way.UCSC.mm10")
#' 
#' 
#' ## ---------------------------------------------------------------------
